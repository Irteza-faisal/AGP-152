...
**MODEL**: ResNet152 (Quantised)<br>
**WEBSITE LINK**: https://age-gender-predictor-152.web.app
...
For more information, visit the [GitHub Repository](https://github.com/Irteza-faisal/AGP-152).
